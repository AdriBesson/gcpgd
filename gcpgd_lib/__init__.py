...
Submodules:
  ...
  recovery      Annihilating-filter location recovery
  metrics       Performance metrics (match errors, Wilson confidence intervals)
"""
...
from .metrics import circular_match_error, average_match_error, wilson_ci
